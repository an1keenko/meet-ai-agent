...
/**
 * A wrapper component for Radix UI's Collapsible, adding a `data-slot="collapsible"` attribute.
 *
 * Forwards all props to the underlying {@link CollapsiblePrimitive.Root} component.
 */
